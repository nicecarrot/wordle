...
function M$1(a2, b, e) {
  ...
  if (a2 && a2.defaultProps)
    for (d in g = a2.defaultProps, g)
      void 0 === c[d] && (c[d] = g[d]);
  return { $$typeof: l, type: a2, key: k, ref: h, props: c, _owner: K$1.current };
}
function N$1(a2, b) {
...
function R$1(a2, b, e, d, c) {
  ...
  if (h)
    return h = a2, c = c(h), a2 = "" === d ? "." + Q$1(h, 0) : d, I$1(c) ? (e = "", null != a2 && (e = a2.replace(P$1, "$&/") + "/"), R$1(c, b, e, "", function(a3) {
      return a3;
  ...
  else if (f = A$1(a2), "function" === typeof f)
...
react_production_min.cloneElement = function(a2, b, e) {
  ...
  var d = C$1({}, a2.props), c = a2.key, k = a2.ref, h = a2._owner;
  if (null != b) {
...
(function(exports) {
    ...
    if (c !== b) {
      ...
      a:
        for (var d = 0, e = a2.length, w2 = e >>> 1; d < w2; ) {
          ...
          if (0 > g(C2, c))
            n2 < e && 0 > g(x2, C2) ? (a2[d] = x2, a2[n2] = c, d = n2) : (a2[d] = C2, a2[m2] = c, d = m2);
  ...
  exports.unstable_scheduleCallback = function(a2, b, c) {
    ...
    c > d ? (a2.sortIndex = c, f(t2, a2), null === h(r2) && a2 === h(t2) && (B2 ? (E2(L2), L2 = -1) : B2 = true, K2(H2, c - d))) : (a2.sortIndex = e, f(r2, a2), A2 || z2 || (A2 = true, I2(J2)));
    return a2;
  };
...
function vh(a2) {
  ...
  function y2(a3, b2, c2, d2, e2) {
    ...
    if ("object" === typeof d2 && null !== d2) {
      switch (d2.$$typeof) {
        ...
        case Ha:
          var f2 = d2._init;
          return y2(a3, b2, c2, f2(d2._payload), e2);
      }
      if (eb(d2) || Ka(d2))
  ...
  function n2(e2, g2, h2, k2) {
    ...
    for (u2 = d(e2, u2); w2 < h2.length; w2++)
      x2 = y2(u2, e2, w2, h2[w2], k2), null !== x2 && (a2 && null !== x2.alternate && u2.delete(null === x2.key ? w2 : x2.key), g2 = f(x2, g2, w2), null === m3 ? l3 = x2 : m3.sibling = x2, m3 = x2);
  ...
  function t2(e2, g2, h2, k2) {
    ...
    for (m3 = d(e2, m3); !n3.done; w2++, n3 = h2.next())
      n3 = y2(m3, e2, w2, n3.value, k2), null !== n3 && (a2 && null !== n3.alternate && m3.delete(null === n3.key ? w2 : n3.key), g2 = f(n3, g2, w2), null === u2 ? l3 = n3 : u2.sibling = n3, u2 = n3);
    ...
    if ("object" === typeof f2 && null !== f2) {
      switch (f2.$$typeof) {
        ...
        case wa:
          ...
          return g(a3);
        case Ha:
          return l3 = f2._init, J2(a3, d2, l3(f2._payload), h2);
      }
      if (eb(f2))
    ...
    for (l2 in d) {
      ...
      if (d.hasOwnProperty(l2) && k !== h && (null != k || null != h))
        if ("style" === l2)
          ...
          "dangerouslySetInnerHTML" === l2 ? (k = k ? k.__html : void 0, h = h ? h.__html : void 0, null != k && h !== k && (f = f || []).push(l2, k)) : "children" === l2 ? "string" !== typeof k && "number" !== typeof k || (f = f || []).push(l2, "" + k) : "suppressContentEditableWarning" !== l2 && "suppressHydrationWarning" !== l2 && (ea.hasOwnProperty(l2) ? (null != k && "onScroll" === l2 && D("scroll", a2), f || h === k || (f = [])) : (f = f || []).push(l2, k));
    }
    c && (f = f || []).push("style", c);
    var l2 = f;
    if (b.updateQueue = l2)
    ...
    if ("selectionStart" in a2)
      ...
      a: {
        ...
        if (d && 0 !== d.rangeCount) {
          ...
          var g = 0, h = -1, k = -1, l2 = 0, m2 = 0, q2 = a2, r2 = null;
          b:
            for (; ; ) {
              for (var y2; ; ) {
...
var Icon = function(e) {
  ...
  var n2 = r2(1), o = r2(0), l2 = function() {
    ...
    return r3;
  }, a2 = 0, s = n2.forwardRef(function(e2, t3) {
    ...
    var k, T2 = "stack_labelledby_" + a2, q2 = "stack_describedby_" + a2;
    if (o2)
      S2 = c2 ? T2 + " " + q2 : T2;
...
const Header = () => {
  ...
  return /* @__PURE__ */ jsxDevRuntime.exports.jsxDEV("header", {
    ...
    children: [/* @__PURE__ */ jsxDevRuntime.exports.jsxDEV("span", {
      ...
      onClick: GameRule,
      children: /* @__PURE__ */ jsxDevRuntime.exports.jsxDEV(Icon, {
      ...
      lineNumber: 25,
      columnNumber: 7
    }, void 0), /* @__PURE__ */ jsxDevRuntime.exports.jsxDEV("span", {
...
const Completerow = ({
  ...
  return /* @__PURE__ */ jsxDevRuntime.exports.jsxDEV("div", {
    ...
    children: Array(5).fill("").map((_, i) => /* @__PURE__ */ jsxDevRuntime.exports.jsxDEV(Tile, {
      letter: word[i],
      state: checkLetter(i)
    }, i, false, {
...
const Currentrow = ({
  ...
  return /* @__PURE__ */ jsxDevRuntime.exports.jsxDEV("div", {
    className: styles.row,
    children: [word.split("").map((letter, i) => /* @__PURE__ */ jsxDevRuntime.exports.jsxDEV(Tile, {
      letter,
      state: "edit"
    }, i, false, {
      ...
      lineNumber: 13,
      columnNumber: 9
    }, void 0)), Array.from(Array(5 - word.length)).map((letter, i) => /* @__PURE__ */ jsxDevRuntime.exports.jsxDEV(Tile, {
      letter,
      state: "edit"
    }, i, false, {
      fileName: _jsxFileName$5,
...
const Emptyrow = () => {
  return /* @__PURE__ */ jsxDevRuntime.exports.jsxDEV("div", {
    className: styles.row,
    children: Array.from(Array(5)).map((_, i) => /* @__PURE__ */ jsxDevRuntime.exports.jsxDEV(Tile, {
      letter: "",
      state: "empty"
    }, i, false, {
...
const Board = () => {
  ...
  return /* @__PURE__ */ jsxDevRuntime.exports.jsxDEV("div", {
    ...
    children: [completedWord.map((word, i) => /* @__PURE__ */ jsxDevRuntime.exports.jsxDEV(Completerow, {
      word,
      solution: answer
    }, i, false, {
      ...
      lineNumber: 184,
      columnNumber: 9
    }, void 0)), gameState !== "Playing" ? null : /* @__PURE__ */ jsxDevRuntime.exports.jsxDEV(Currentrow, {
      word: currentWord
    }, void 0, false, {
      fileName: _jsxFileName$3,
      lineNumber: 186,
      columnNumber: 41
    }, void 0), gameState === "Defeat" ? null : Array.from(Array(CHANCE - turn)).map((_, i) => /* @__PURE__ */ jsxDevRuntime.exports.jsxDEV(Emptyrow, {}, i, false, {
      fileName: _jsxFileName$3,
      lineNumber: 189,
      columnNumber: 58
    }, void 0))]
...
const Main$1 = () => {
  return /* @__PURE__ */ jsxDevRuntime.exports.jsxDEV(jsxDevRuntime.exports.Fragment, {
    children: /* @__PURE__ */ jsxDevRuntime.exports.jsxDEV(Board, {}, void 0, false, {
...
function App() {
  return /* @__PURE__ */ jsxDevRuntime.exports.jsxDEV(jsxDevRuntime.exports.Fragment, {
    children: [/* @__PURE__ */ jsxDevRuntime.exports.jsxDEV(Header, {}, void 0, false, {
      ...
      lineNumber: 9,
      columnNumber: 7
    }, this), /* @__PURE__ */ jsxDevRuntime.exports.jsxDEV(Main$1, {}, void 0, false, {
      fileName: _jsxFileName$1,
      lineNumber: 10,
      columnNumber: 7
    }, this)]
